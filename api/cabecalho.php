  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="normalizar_rgb.php">Normalizar RGB</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="rgb_hsv.php">RGB para HSV</a>
        </li>
        <li class="nav-item">
